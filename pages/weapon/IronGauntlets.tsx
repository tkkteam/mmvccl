...
import Head from "next/head";
 ...
 function PremiumAxe() {
  return (
    ...
    <h2 className="font-semibold text-gray-800">Iron Gauntlets</h2>
    <div className="font-semibold badge badge-primary">+1</div>
    <h2 className="font-semibold text-blue-800">Increase quantity of Wood gained </h2>
    <h2 className="font-semibold text-blue-800"> from chopped Woods by +12%</h2>
...
<div className="bg-white w-72 h-130 shadow-md rounded m-3">
    ...
    <h2 className="font-semibold text-blue-800">Increase quantity of Rock gained</h2>
    <h2 className="font-semibold text-blue-800"> from broken Rocks by +12%</h2>
